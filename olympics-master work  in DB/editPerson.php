<?php
    ...
    $allPersonNameCheck = $personController->getAllPeople();
...
//var_dump($_POST['name']);
    if(isset($_POST['name'])){
        if($_POST['id']){
            ...
            foreach ($allPersonNameCheck as $per){
                if($per->getFullName() == $person->getFullName()){
                    exit();
            ...
            $placement->setPersonId($person->getId());
            $placement->setOhId($_POST['ohId']);
            $placement->setPlacing($_POST['placing']);
            $placement->setDiscipline($_POST['discipline']);
            $person->setPlacements($placement);
            $personController->insertPlacements($placement);
