...
$address_site = "https://wt168.fei.stuba.sk/curlZdarova/";
...
$user = $actionsController->getUser($id);
//$actionsController->getAllUserActions($user);
//var_dump($person);
...
<header>
    <?php
        $actionsController->getUserNameById($id);
    ?>
</header>
...
<table class="table">
    ...
    <tbody>
    <?php
        echo $actionsController->getAllUserActions($user);
    ?>
    </tbody>
</table>
